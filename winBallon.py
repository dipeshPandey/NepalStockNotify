##https://github.com/K-DawG007/Stack-Watch/blob/master/windows_popup.py
##pypiwin32
...
class WindowsBalloonTip:
    def __init__(self, title, msg,sec):
...
def balloon_tip(title, msg, seconds):
    w = WindowsBalloonTip(title, msg, seconds)
    return w
